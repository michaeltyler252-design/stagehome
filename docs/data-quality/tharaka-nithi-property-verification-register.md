# Tharaka-Nithi Property Verification Register
...
|---|---|---|---|---|
| 1 | Almark Hostels | Chuka University | SOURCE_SUPPLIED_UNVERIFIED | None flagged — complete record, cleanly bounded at a genuine Images/Street View ending with no trailing bleed |
